...
IGNORE = src/arch/amd64/boot_loader
...
boot_loader:
	$(CC) $(C_32_FLAGS) src/arch/amd64/boot_loader/boot.S -o $(OBJ_DIR)/boot.o
	$(CC) $(C_32_FLAGS) src/arch/amd64/boot_loader/loader.c -o $(OBJ_DIR)/loader.o
...
setup:
	$(CC) $(C_64_FLAGS) src/arch/amd64/boot_loader/entry_64.S -o $(OBJ_DIR)/entry_64.o
